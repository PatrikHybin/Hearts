...
using System.Linq;
/// <summary>
/// Script representing manager for online game.
/// </summary>
public class GameManagerHearts : NetworkBehaviour
{
    /// <summary>
    /// Instance for online game manager.
    /// </summary>
    public static GameManagerHearts gameManager;
    /// <summary>
    /// Field for keeping count of how many players are ready.
    /// </summary>
    public int ready = 0; 
    ...
    /// <summary>
    /// Field for number of current round.
    /// </summary>
    public int currentRound = 0;
    /// <summary>
    /// Field for end of the game.
    /// </summary>
    public bool gameEnded = false;
    /// <summary>
    /// Field for phase when players are giving cards.
    /// </summary>
    public bool giveCards;
    /// <summary>
    /// Field for phase when player is playing.
    /// </summary>
    ...
    /// <summary>
    /// Method that will start game. Method is called on server.
    /// </summary>
    [Server]
    ...
    /// <summary>
    /// Method that will fill out everything about card for each player in game.
    /// </summary>
    /// <param name="card"></param>
    /// <param name="cardSpriteName"></param>
    /// <param name="cardBackName"></param>
    [ClientRpc]
    ...
    /// <summary>
    /// Method that will set up holders for cards for each player. Method will secure that player can only interact will his holders.
    /// </summary>
    /// <param name="handHolderInstance"></param>
    /// <param name="showHolderInstance"></param>
    /// <param name="enemyShowHolderInstance"></param>
    /// <param name="giveHolderInstance"></param>
    /// <param name="playAreaHolderInstance"></param>
    /// <param name="usedCardHolderInstance"></param>
    /// <param name="indexOfPlayer"></param>
    [ClientRpc]
    ...
    /// <summary>
    /// Method that will show front side of card to player who owns it and allow him to interact with it.
    /// If player doesn't own that card he see back side and can't interact with it.
    /// </summary>
    /// <param name="card"></param>
    /// <param name="indexOfPlayer"></param>
    [ClientRpc]
    public void RpcShowCard(GameObject card, int indexOfPlayer)
    {
    ...
    /// <summary>
    /// Method that fills score table for each player.
    /// </summary>
    [ClientRpc]
    ...
    /// <summary>
    /// Method that resets play time for player.
    /// </summary>
    ...
    /// <summary>
    /// Method that sets timer for giving time. And check if each player is ready for give phase. 
    /// </summary>
